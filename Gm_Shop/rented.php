...
//echo $duration;
//echo $_POST['idvalue'];
$sql="select Rent_Price from Movies where ID=".$_POST['idvalue'];
...
if($row=mysql_fetch_assoc($result))
{
 ...
 $result =("INSERT INTO Rent (Cust_ID,M_ID,Duration,Price) VALUES ('".$custid."','".$mid."','".$Duration."','".$price."')");
 mysql_query($result);
